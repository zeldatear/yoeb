...
SetNeedSkillLineData(98,"幻步,nil|恢復輔助,nil|召喚寒冰魔像,nil",nil,nil,nil)
...
SetTaskShengJiData("a5q7",nil,"1_5_5",48,true)--做 到奇塔弗的受难 的时候刷纯净圣地到50级再进行下一任务
SetTaskShengJiData("a9q3",nil,"2_9_1",66,true)--做 到風暴飛刃 的时候刷滲血水道到68级再进行下一任务

SetTaskMiGongData("a8q1",nil,1)--在死亡和重生这个任务时 做迷宫1
SetTaskMiGongData("a10q1",nil,2)--在死亡和重生这个任务时 做迷宫2

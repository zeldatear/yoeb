...
SetNeedSkillLineData(96,"狂戰,nil|鋼筋鐵骨,nil|鮮血狂怒,nil",nil,10,nil)
SetNeedSkillLineData(97,"啟蒙,nil|元素淨化,nil|憤怒,nil",nil,9,nil)
SetNeedSkillLineData(98,"擊中時印記輔助,nil|狙擊者印記,nil|幻步,nil|恢復輔助,nil",nil,5,nil)
SetNeedSkillLineData(99,"魔改箭矢輔助,nil|狂怒,nil|龍捲射擊,nil|誘捕箭矢,nil|誘捕,nil|暴擊獲得暴擊球輔助,nil",nil,3,nil)
SetNeedSkillLineData(100,"瓦爾．閃電箭矢,nil|幻影射手輔助,nil|元素攻擊傷害輔助,nil|啟發輔助,nil|三體輔助,nil|投射物返回輔助,nil",nil,2,nil)
SetNeedSkillLineData(1,"燃燒箭矢,nil|氣勢輔助,nil",2,nil,nil)
...
SetZhengTiColorVarData(10,4,1,0,nil,400,true)
SetZhengTiColorVarData(10,3,0,0,nil,300,true)
...
SetTaskShengJiData("a5q7",nil,"1_5_5",45,true)--做 到奇塔弗的受难 的时候刷纯净圣地到50级再进行下一任务
